    ...
    >
      ...
      >
        <div class="p-4 md:p-12 text-center lg:text-left">
          ...
          >
            <a class="link" @click="redirect(profile.facebookLink)" data-tippy-content="@facebook_handle"
              ><svg
              ...
              >
                ...
                /></svg
            ></a>
            <a class="link" @click="redirect(profile.twitterLink)" data-tippy-content="@twitter_handle"
              ><svg
                class="h-6 fill-current text-gray-600 hover:text-green-700"
                role="img"
                viewBox="0 0 24 24"
              ...
              >
                ...
                /></svg
            ></a>
            <a class="link" @click="redirect(profile.githubLink)" data-tippy-content="@github_handle"
              ><svg
                class="h-6 fill-current text-gray-600 hover:text-green-700"
                role="img"
                viewBox="0 0 24 24"
            ...
            <a class="link" @click="redirect(profile.instagramLink)" data-tippy-content="@instagram_handle"
              ><svg
                class="h-6 fill-current text-gray-600 hover:text-green-700"
                role="img"
                viewBox="0 0 24 24"
              ...
              >
                ...
                /></svg
            ></a>
            <a class="link" @click="redirect(profile.youtubeLink)" data-tippy-content="@youtube_handle"
              ><svg
                class="h-6 fill-current text-gray-600 hover:text-green-700"
                role="img"
                xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="w-full lg:w-2/5">
        ...
        <img
          src="https://lh3.googleusercontent.com/a/AATXAJxf7CWDVpFwPYf3EilWOQNaoGyPmwkm8muFutV9=s96-c"
