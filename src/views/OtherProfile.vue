      ...
      >
        <div class="p-4 md:p-12 text-center lg:text-left">
          ...
          >
            <a
              class="link"
              @click="redirect(profile.facebookLink)"
            ...
            <a
              class="link"
              @click="redirect(profile.twitterLink)"
            ...
            <a
              class="link"
              @click="redirect(profile.githubLink)"
            ...
            <a
              class="link"
              @click="redirect(profile.instagramLink)"
            ...
            <a
              class="link"
              @click="redirect(profile.youtubeLink)"
